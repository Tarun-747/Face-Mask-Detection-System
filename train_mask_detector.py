...
DIRECTORY = r"C:\Users\Tarun\Desktop\Face-Mask-Detection-master\Face-Mask-Detection-master\dataset"
...
opt = tf.keras.optimizers.Adam(learning_rate=INIT_LR)     #Adam optimizer to be used with specified learning rate and decay
